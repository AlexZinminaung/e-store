...
const Navbar = () => {
    ...
    return (
        <nav className='flex justify-between items-center fixed w-full z-10 backdrop-blur-2xl sm:gap-8 border-b border-gray-800 py-4 px-4 sm:px-8'>
            <p className='text-xl font-bowlby  text-nowrap'>E-<span className=' text-blue-400'>Store</span></p>
            ...
            <a className='p-2 border border-gray-800 rounded-md hover:text-blue-400 hover:border-blue-400 flex items-center gap-1 relative'> 
            ...
            <a className='p-2 border border-gray-800 rounded-md hover:text-blue-400 hover:border-blue-400'>Login</a>
            <a className='p-2 border border-blue-400 text-black bg-blue-400 rounded-md '>Register</a>
            </div>
        </nav>
    );
}
